            ...
            if($datas){
                          ...
                          <tr>
                           ...
                           <td><img src="<?= base_url('upload/customer/'.$data->image) ?>" width="80px" height="80px"></td> 
                            <td>
								<a href="<?= base_url('customerprofile/'.$data->id) ?>" class="btn btn-primary">Profile</a>
								<a href="<?= base_url('customertrans/'.$data->account_no) ?>" class="btn btn-primary">Transaction</a>
								<a href="<?= base_url('customeredit/'.$data->id) ?>" class="btn btn-primary">Edit</a>
								<a href="<?= base_url('customerdelete/'.$data->id) ?>" class="btn btn-danger">Delete</a>
							</td>
                          </tr>
						<?php } } ?>
                        </tbody>
